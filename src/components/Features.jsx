...
function Features({ onCtaClick }) {
  const features = [
    { 
      ...
      desc: "Type natural language commands and smart filters to find the right talent 70% faster.",
      color: "#f97316"
    },
    { 
      icon: <Lock size={24} />, 
      title: "Private Talent Vault", 
      desc: "Search your own trusted database with tags, training, and history always in one place.",
      color: "#10b981"
    },
    { 
      icon: <Users size={24} />, 
    ...
    { 
      ...
      desc: "View projects, roles, auditions, and follow-ups in one clear real-time dashboard.",
      color: "#06b6d4"
    },
    { 
      icon: <ImageIcon size={24} />, 
      title: "Visual Outreach Studio", 
      desc: "Generate co-branded casting posters that are ready to share across social and WhatsApp.",
      color: "#ec4899"
    },
    { 
      icon: <MessageSquare size={24} />, 
      title: "WhatsApp Outreach Automation", 
      desc: "Broadcast, segment, and 1:1 message talent with polished outreach in just a few clicks.",
      color: "#25d366"
    },
    { 
      icon: <FileText size={24} />, 
      title: "Smart Agreements & Contracts", 
      desc: "Send digital T&Cs, per diems, and confirmations so work starts without paperwork delays.",
      color: "#3b82f6"
    },
    { 
      icon: <Star size={24} />, 
      title: "Reputation & Reliability Scores", 
      desc: "Track feedback for talent and clients so you always know who delivers on set.",
      color: "#ef4444"
    },
    { 
      icon: <ExternalLink size={24} />, 
      title: "Team & Client Collaboration", 
      desc: "Share clear shortlists and updates with your team and clients without messy spreadsheets.",
      color: "#64748b"
    }
  ];
