  ...
  return (
    <section className="cta-section">
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <h2 className="cta-title">Ready to professionalize your casting?</h2>
        <p className="cta-subtitle">
          Join the elite circle of casting directors and acting schools using JAMz to power their daily workflows.
        </p>
